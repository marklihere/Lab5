...
void TIMER1A_Handler(void) {
  ...
  // See lab report for full justification
  // calculating the slope (20000 - 2000)/4096 = 4.39560439560439
  // therefore in point slope form is y = 4.39560439560439x + 2000
  // in our case x = adcsamples / 250, as adcsamples is a running total of the last
  // 250 ADC samples
...
void INIT_I2C(void){
    ...
    I2C0->MTPR = TPR;           // cfg for 400 kHz fast clock
